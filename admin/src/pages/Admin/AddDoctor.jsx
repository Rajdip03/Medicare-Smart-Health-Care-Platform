  ...
  return (
    <form onSubmit={onSubmitHandler} className='m-5 w-full'>
      ...
      <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
        ...
        <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
          <div className='w-full lg:flex-1 flex flex-col gap-4'>
            ...
            <div className='w-full lg:flex-1 flex flex-col gap-4'>
              ...
              {/* Move About Doctor here (after Address) */}
              <div className='mt-4'>
              ...
              {/* placeholder to keep layout similar to original (right column present) */}
        ...
        {/* Submit button placed at bottom to keep layout clean */}
        <div className='mt-6'>
          <button type='submit' className='bg-[#36486B] px-10 py-3 mt-4 text-white rounded-full'>Add Doctor</button>
        </div>
